...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='pointer512',
                             help='coco | kitti | coco_hp | pascal | pointer512')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 1, 
                'mean': [0.536, 0.511, 0.486], 'std': [0.194, 0.197, 0.206],
                'dataset': 'pointer512'},
      ...
      'multi_pose': {
        ...
        'mean': [0.536, 0.511, 0.486], 'std': [0.194, 0.197, 0.206],
        'dataset': 'pointer512', 'num_joints': 6,
